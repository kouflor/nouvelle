...
function kopa_font_style_options() {
	return apply_filters( 'kopa_font_style_options', array(
		array (
			'style' => '100',
			'label' => __( 'Thin', 'new-lotus' ),
		),
		array (
			'style' => '100italic',
			'label' => __( 'Thin/Italic', 'new-lotus' ),
		),
		array (
			'style' => '200',
			'label' => __( 'Extra-Light', 'new-lotus' ),
		),
		array (
			'style' => '200italic',
			'label' => __( 'Extra-Light/Italic', 'new-lotus' ),
		),
		array (
			'style' => '300',
			'label' => __( 'Light', 'new-lotus' ),
		),
		array (
			'style' => '300italic',
			'label' => __( 'Light/Italic', 'new-lotus' ),
		),
		array (
			'style' => '400',
			'label' => __( 'Normal', 'new-lotus' ),
		),
		array (
			'style' => '400italic',
			'label' => __( 'Normal/Italic', 'new-lotus' ),
		),
		array (
			'style' => 'regular',
			'label' => __( 'Normal', 'new-lotus' ),
		...
		array (
			'style' => '500',
			'label' => __( 'Medium', 'new-lotus' ),
		),
		array (
			'style' => '500italic',
			'label' => __( 'Medium/Italic', 'new-lotus' ),
		),
		array (
			'style' => '600',
			'label' => __( 'Semi-Bold', 'new-lotus' ),
		),
		array (
			'style' => '600italic',
			'label' => __( 'Semi-Bold/Italic', 'new-lotus' ),
		),
		array (
			'style' => '700',
			'label' => __( 'Bold', 'new-lotus' ),
		),
		array (
			'style' => '700italic',
			'label' => __( 'Bold/Italic', 'new-lotus' ),
		),
		array (
			'style' => 'bold',
			'label' => __( 'Bold', 'new-lotus' ),
		...
		array (
			'style' => '800',
			'label' => __( 'Extra-Bold', 'new-lotus' ),
		),
		array (
			'style' => '800italic',
			'label' => __( 'Extra-Bold/Italic', 'new-lotus' ),
		),
		array (
			'style' => '900',
			'label' => __( 'Ultra-Bold', 'new-lotus' ),
		),
		array (
			'style' => '900italic',
			'label' => __( 'Ultra-Bold/Italic', 'new-lotus' ),
		),
	) );
}
