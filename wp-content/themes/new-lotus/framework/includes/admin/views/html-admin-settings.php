<div id="kopa_options_wrap" class="wrap">
			...
			<form enctype="multipart/form-data" id="kopa_options_form" action="" method="post">
				...
				<div class="kopa_options_content">
					...
					<div id="kopa_options_submit_top">
						<input type="submit" class="button-primary kopa_save" name="update" value="<?php esc_attr_e( 'Save Options', 'new-lotus' ); ?>" />
					</div>
					<?php } ?>
	...
	<div class="kopa_modal kopa_hide" id="kopa_modal_info">
		...
		<p id="kopa_modal_confirm">
			<input class="button button-primary" id="kopa_confirm_ok" type="submit"  value="<?php esc_attr_e( 'OK', 'new-lotus' ); ?>">
			<input class="button" id="kopa_confirm_cancel" type="submit"  value="<?php esc_attr_e( 'Cancel', 'new-lotus' ); ?>">
		</p>
	</div>
</div> <!-- / .wrap -->